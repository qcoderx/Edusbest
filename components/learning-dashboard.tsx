...
import { Brain, BookOpen, Target, Clock, TrendingUp, Sparkles, Settings, Calendar, Award } from "lucide-react"
...
export function LearningDashboard({ userProfile, onResetProfile }: LearningDashboardProps) {
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 text-lg mt-2">Ready to continue your personalized learning journey?</p>
          </div>
          <Button variant="outline" onClick={onResetProfile} className="flex items-center gap-2 bg-transparent">
