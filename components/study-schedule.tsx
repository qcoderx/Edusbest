        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
            {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].map((day) => {
              ...
              const isStudyDay = userProfile.studyDays.includes(day)
              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-lg border ${
                    isStudyDay ? "bg-blue-50 border-blue-200" : "bg-gray-50 border-gray-200"
                  }`}
                >
                  ...
                  {daySchedule.length > 0 ? (
                    ...
                    <div className="text-center text-gray-400 text-xs">{isStudyDay ? "No sessions" : "Rest day"}</div>
                  )}
                </div>
              )
            })}
