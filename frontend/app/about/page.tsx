        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
              About <span className="text-blue-600 dark:text-blue-400">Curio</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              We're revolutionizing learning through AI-powered content curation. 
              Our mission is to make quality learning content accessible to everyone, everywhere.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                At Curio, we believe that every learner deserves personalized content curation 
                that adapts to their unique interests, pace, and learning style. 
                Our AI-powered platform bridges knowledge gaps and empowers learners 
                to discover their full potential.
              </p>
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                We're committed to making quality learning content accessible to learners 
                worldwide, using cutting-edge technology to create meaningful 
                discovery experiences that drive real results.
              </p>
              <div className="flex items-center space-x-4">
                <Link href="/student">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-xl">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Personalized Curation</h3>
                <p className="text-gray-600 dark:text-gray-300">AI-driven content discovery that adapts to each learner's needs</p>
              </div>
              <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-xl">
                ...
                <p className="text-gray-600 dark:text-gray-300">Instant insights into learning progress and interests</p>
              </div>
              <div className="bg-purple-50 dark:bg-purple-900/20 p-6 rounded-xl">
                ...
                <p className="text-gray-600 dark:text-gray-300">Quality content available anywhere, anytime</p>
              </div>
              <div className="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-xl">
                ...
                <p className="text-gray-600 dark:text-gray-300">Your data and privacy are our top priority</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Our AI-powered platform creates a personalized content discovery experience 
              that evolves with each learner's interests and needs.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">AI-Powered Discovery</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Our advanced AI algorithms analyze your interests, learning patterns, 
                and preferences to create a personalized content discovery profile.
              </p>
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Smart Content Curation</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Based on your profile, our system curates and organizes content, 
                resources, and learning materials that match your interests and pace.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600 dark:text-gray-300">
                  <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Continuous Learning</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                The system continuously learns from your interactions and adjusts 
                content recommendations to maximize your learning discovery.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600 dark:text-gray-300">
                  <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
      ...
      <section className="py-20 bg-white dark:bg-gray-900 transition-colors duration-200">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              We're a passionate team of technologists, educators, and innovators 
              dedicated to transforming learning through intelligent content curation.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Content Experts</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Our team includes experienced content curators and learning specialists 
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">AI Specialists</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Leading machine learning engineers and data scientists who develop 
                cutting-edge AI algorithms for content curation.
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Product Designers</h3>
              <p className="text-gray-600 dark:text-gray-300">
                UX/UI experts who create intuitive, engaging discovery experiences 
                that learners love to use.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800 transition-colors duration-200">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of learners who are already transforming their learning 
            with Curio's AI-powered content curation platform.
          </p>
          <Link href="/student">
